...
%% load the data
coordFilePath = fullfile(userpath, 'npc_average', 'donut_50smpl.mat');
load(coordFilePath);
nSmpls = size(smplCoord, 1);

imageFilePath = fullfile(userpath, 'npc_average', 'overview.tif');
...
for i = 1:nSmpls
    ...
    upri = lole + roiSz - 1;
    J = I(lole(2):upri(2), lole(1):upri(1));
